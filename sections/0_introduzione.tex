...
Nonostante gran parte delle eruzioni non dipenda da attività sismica, studiare questo fenomeno è comunque di grande importanza per migliorare la gestione del rischio \citep{Seropian2021EarthquakesVolcanoes} \textcolor{red}{("towards more efficient hazard management approaches", non ho una buona traduzione per questo concetto)}.
