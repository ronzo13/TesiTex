...
In questa tesi i vulcani presi in esame sono due: il Krasheninnikov e il Klyuchevskoy, entrambi situati nella CKD. 
...
\\
TODO: parlare dell'ultima eruzione

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{graphics/photo_klyuchevskoy.png}
...
Il Krasheninnikov (Fig. \ref{fig:photo_krasheninnikov}) è un vulcano costituito da due stratovulcani sovrapposti all'interno di una caldera formatasi nel Pleistocene di dimensione \qty{9e1}{\kilo\meter} \citep{GVP_Krasheninnikov}. Una caldera è una depressione generata a seguito del collasso di un edificio vulcanico sopra la camera magmatica, tipicamente dopo un'eruzione.
  

\citep{Ponomareva2025Krasheninnikov}
\\
TODO: parlare dell'ultima eruzione

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{graphics/photo_krasheninnikov.png}
