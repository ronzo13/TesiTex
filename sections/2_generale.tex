...
\begin{minipage}{0.6\textwidth}
    \includegraphics[width=\linewidth]{graphics/kamchatka_volcano_map.png}
\end{minipage}%
\hfill
\begin{minipage}{0.35\textwidth}
    ...
    Tra questi due fronti
    è presente la Central
...
\begin{figure}[H]
    ...
    \caption{[preso da \citet{GVP_Krasheninnikov}]}
...
\begin{figure}[H]
    ...
    \caption{[preso da \citet{GVP_Klyuchevskoy}]}
