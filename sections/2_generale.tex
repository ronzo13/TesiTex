...
\begin{figure}[H]
    ...
    \caption{Proiezione superficiale dello slip per il terremoto del 29 luglio 2025 in Kamchatka. La scala di colore dal bianco al bli indica l'intensità dello slip. La linea bianca indica il confine tra due placche [preso da \citep{usgs2025qw60finitefault}].}
    \label{fig:basemap}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{graphics/slip.png}
    \caption{Caption}
    \label{fig:slip}
\end{figure}
